...
func (c *echoServiceClient) ServerStreamingEcho(ctx context.Context, in *ServerStreamingEchoRequest, opts ...grpc.CallOption) (EchoService_ServerStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &EchoService_ServiceDesc.Streams[0], "/echo.v1.EchoService/ServerStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *echoServiceClient) ClientStreamingEcho(ctx context.Context, opts ...grpc.CallOption) (EchoService_ClientStreamingEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &EchoService_ServiceDesc.Streams[1], "/echo.v1.EchoService/ClientStreamingEcho", opts...)
	if err != nil {
		return nil, err
	}
...
var EchoService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "examples/logging-grpc/v1/echo.proto",
}
